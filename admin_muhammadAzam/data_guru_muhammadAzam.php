...
$sort_order = isset($_GET['sort_order']) ? $_GET['sort_order'] : 'ASC'; // Default is ASC (A-Z)
...
$query .= " ORDER BY g.nama_lengkap_muhammadAzam $sort_order";

$result = mysqli_query($koneksi_muhammadAzam, $query);
$teachers = mysqli_fetch_all($result, MYSQLI_ASSOC);

// Fetch mapel data
$mapel = mysqli_query($koneksi_muhammadAzam, "SELECT * FROM tb_mapel_muhammadAzam");
...
<div class="wrapper">
    ...
    <main class="main">
        ...
        <form method="get" action="data_guru_muhammadAzam.php">
            ...
            <div>
                <label for="sort_order">Urutkan Nama:</label>
